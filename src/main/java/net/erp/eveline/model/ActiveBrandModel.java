...
public class ActiveBrandModel {
    ...
    public ActiveBrandModel setId(final String id) {
        this.id = id;
        return this;
    }
    ...
    public ActiveBrandModel setEnabled(final Boolean enabled) {
    ...
    public ActiveBrandModel setLastUser(final String lastUser) {
    ...
    public boolean equals(final Object o) {
        ...
        ActiveBrandModel that = (ActiveBrandModel) o;
