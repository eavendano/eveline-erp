...
public class ActiveWarehouseModel {
    private String id;
    ...
    public ActiveWarehouseModel setId(final String id) {
        this.id = id;
        return this;
    }
    ...
    public ActiveWarehouseModel setEnabled(final Boolean enabled) {
    ...
    public ActiveWarehouseModel setLastUser(final String lastUser) {
    ...
    public boolean equals(final Object o) {
        ...
        ActiveWarehouseModel that = (ActiveWarehouseModel) o;
